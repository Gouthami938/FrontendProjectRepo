...
function Platinum() {
        ...
        function redirectp()
        {
          ...
          navigate('/Acceptlist')
          toast.success('Paltinum Membership Availed')
        }
...
<Container>
        ...
        <Row className="mt-4">
                ...
                <CardHeader>
        <h3><span style={{fontFamily:'Times new Roman',fontWeight:'bold'}}>Platinum Subscription</span></h3>
       <h5><span style={{fontFamily:'Times new Roman',fontWeight:'bold'}}>From INR</span></h5>  
        ...
        <h3><span style={{fontFamily:'Times new Roman',fontWeight:'bold'}}>{'\u20B9'}3000/month</span></h3>
        <h5><span style={{fontFamily:'Times new Roman',fontWeight:'bold'}}>#Full Profile can be viewed</span></h5>
        <Button onClick={redirectp} color={'dark'}>Pay{'\u20B9'}3000</Button>
